package io.github.ashayking.apis;
...
import io.github.ashayking.model.CommentResource;
...
public class CommentsService {
	...
	public CommentCollectionResource getCommentsForTask(String taskId) {
		...
		return restTemplate.getForObject(String.format("http://comments-service/comments/%s", taskId),
